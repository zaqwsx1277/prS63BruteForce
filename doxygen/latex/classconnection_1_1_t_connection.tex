...
connection\+Confirm&Подтверждение сервера о подключении. Запрос клиента о подключенности \\
\hline
...
transfer\+Data&Со стороны сервере передается начальный ключ. Со стороны клиента передается подобранный ключ \\
\hline
